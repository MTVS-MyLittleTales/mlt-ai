...
def make_canvas_mask(x_start, y_start, target_img, mask):
    ...
    canvas_mask[int(x_start-mask.shape[0]*0.625):int(x_start+mask.shape[0]*0.625), int(y_start-mask.shape[1]*0.5):int(y_start+mask.shape[1]*0.5)] = mask
    return canvas_mask
...
def compute_gt_gradient(x_start, y_start, source_img, target_img, mask, gpu_id):
    ...
    canvas_mask = np.zeros((target_img.shape[0], target_img.shape[1]))
    canvas_mask[int(x_start-source_img.shape[0]*0.625):int(x_start+source_img.shape[0]*0.625), int(y_start-source_img.shape[1]*0.5):int(y_start+source_img.shape[1]*0.5)] = mask
    ...
    red_foreground_gradient[int(x_start-source_img.shape[0]*0.625):int(x_start+source_img.shape[0]*0.625), int(y_start-source_img.shape[1]*0.5):int(y_start+source_img.shape[1]*0.5)] = red_source_gradient
    green_foreground_gradient = np.zeros((canvas_mask.shape))
    green_foreground_gradient[int(x_start-source_img.shape[0]*0.625):int(x_start+source_img.shape[0]*0.625), int(y_start-source_img.shape[1]*0.5):int(y_start+source_img.shape[1]*0.5)] = green_source_gradient
    blue_foreground_gradient = np.zeros((canvas_mask.shape))
    blue_foreground_gradient[int(x_start-source_img.shape[0]*0.625):int(x_start+source_img.shape[0]*0.625), int(y_start-source_img.shape[1]*0.5):int(y_start+source_img.shape[1]*0.5)] = blue_source_gradient
